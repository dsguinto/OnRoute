...
<main>
    ...
    <form method="post" action="//localhost/HTTP5202/OnRoute/accommodations/hotelDetails.php">
    ...
    <div class="deals">
        ...
        <div class="deals__budget">
            ...
            <div class="deals__budget_opt">
                <p><a href="../images/accommodations/a13.jpg"><img src="../mages/accommodations/a13.jpg" alt="" width="" /></a></p>
            </div>
        </div>
        </div>
    </div>
